    ...
    return (
        <>
            ...
            {cartProducts.length > 0 && (
                <div className='container-fluid'>
                    ...
                    <div className='summary-box'>
                        ...
                        <br></br>
                        <StripeCheckout
                            stripeKey='pk_test_51JqEGsHb55M2TnhV15BYBAwKQ5CvtiYRd5s3GhUQLW3nV7WMVeg04Oht8RnR4YV03AKz8SzSrvunuLD1u91BRiuY00Y0nM6JNM'
                            token={handleToken}
                            billingAddress
                            shippingAddress
                            name='All Products'
            ...
            {cartProducts.length < 1 && (
                <div className='container-fluid'>
                    <Link to="/" className="btn btn-primary btn-buy"> BUY PRODUCTS </Link>
                </div>
              ) }
